        ...
        return(
          <Grid>
            <Col md={3}>
              ...
              <p style={{marginBottom: 0}}>Your store:</p><strong><h3 style={{marginTop: 5, marginBottom:  5}} >Poinciana</h3></strong> <p>2433 Pleasant Hill Rd Kissimmee, Florida, 34746</p><Link to="/">Change location</Link>
              </Box>
            </Col>
